...
\longformpublication{\ding{229}\, O.~Atkinson, {\bf M.~Black}, A.~Lenz, A.~Rusov and J.~Wynne, {\it Cornering the Two Higgs Doublet Model Type II}, JHEP \textbf{04} (2022) 172, \\ \phantom{i} [\href{https://arxiv.org/abs/2107.05650}{arXiv:2107.05650 [hep-ph]}]} \\[5pt]
\longformpublication{\ding{229}\, O.~Atkinson, {\bf M.~Black}, C.~Englert, A.~Lenz, A.~Rusov and J.~Wynne, {\it The Flavourful Present and Future of 2HDMs at the Collider Energy Frontier}, in review at JHEP, [\href{https://arxiv.org/abs/2202.08807}{arXiv:2202.08807 [hep-ph]}]} \\[5pt]
\longformpublication{\ding{229}\, O.~Atkinson, {\bf M.~Black}, C.~Englert, A.~Lenz and A.~Rusov, {\it MUonE, muon $g-2$ and electroweak precision constraints within 2HDMs}, \\ in review at Phys.Rev.D, [\href{https://arxiv.org/abs/2207.02789}{arXiv:2207.02789 [hep-ph]}]}\\[5pt]
\longformpublication{\ding{229}\, {\bf M.~Black}, A.~D.~Plascencia and G.~Tetlalmatzi-Xolocotzi, {\it Enhancing $B_s \to e^+ e^-$ to an Observable Level in the Two-Higgs-Doublet Model}, in review at JHEP, [\href{https://arxiv.org/abs/2208.08995}{arXiv:2208.08995 [hep-ph]}]}.
...
%%------------------------------------------------
%
\longformdescription{Teaching Assistance}{Throughout my PhD so far, I have taken up teaching assistant duties for various courses. These include `Scientific Programming' and `Practical Lab: Intro to Lattice QCD', as well as helping to supervise a Bachelors student through their thesis work. I have lent my knowledge of particle physics, QCD in particular, and programming in languages such as C++ and Python to good use in order to educate students on these areas and advance their own academic careers.}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{Group}{{\color{linkcolor}\textit{Theoretical Particle Physics Group}}}{}
