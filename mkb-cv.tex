...
\begin{supertabular}{rp{6.7cm}} % Start a table with two columns, the table will ensure everything is aligned
	...
	\educationentry{2021 -- 2024} % Duration
...
\longformpublication{\ding{229}\, {\bf M.~Black}, M.~Lang, A.~Lenz, Z.~W\"uthrich, {\it HQET sum rules for matrix elements of dimension-size four-quark operators for meson lifetimes within and beyond the Standard Model}, JHEP XX (2025) XXX, [\href{https:arxiv.org/abs/2412.13270}{arXiv:2412.13270 [hep=ph]}]}\\[5pt]
\longformpublication{\ding{229}\, {\bf M.~Black}, R.~Harlander, F.~Lange, A.~Rago, A.~Shindler and O.~Witzel, {\it Gradient Flow Renormalisation for Meson Mixing and Lifetimes}, PoS LATTICE2024 243, [\href{https://arxiv.org/abs/2409.18891}{arXiv:2409.18891 [hep-lat]}]}\\[5pt]
...
\parbox[top][0.12\textheight][c]{\linewidth}{ % Parbox to hold the colour box; fixed height to match the name/CV text to the left, centred vertically and full line width
	...
	\colorbox{shade}{ % Create the coloured box
		\begin{supertabular}{p{0.05\linewidth}|p{0.795\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
            ...
            \raisebox{-1pt}{\faHome} & 482/6 Gilmerton Rd, EH17 7SA Edinburgh, Scotland \\ % Address
			\raisebox{-1pt}{\faPhone} & +44 7446 949025, DoB: 26/10/1998 \\ % Phone number
            \raisebox{0pt}{\small\faEnvelope} & \raisebox{0pt}{\color{linkcolor}matthewkblack@protonmail.com}\\
            \raisebox{0pt}{\small\faEnvelope} & \raisebox{0pt}{\color{linkcolor}matthew.black@ed.ac.uk}\\
