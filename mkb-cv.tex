...
\longformpublication{\ding{229}\, {\bf M.~Black}, R.~Harlander, F.~Lange, A.~Rago, A.~Shindler and O.~Witzel, {\it Using Gradient Flow to Renormalise Matrix Elements for Meson Mixing and Lifetimes}, PoS LATTICE2023 XXX, {\it *to appear shortly} \\ \phantom{i} [\href{https://arxiv.org/abs/23XX.XXXX}{arXiv:231X.XXXX [hep-lat]}]}\\[5pt]
